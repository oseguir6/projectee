    ...
    <div className={`min-h-screen ${darkMode ? 'dark' : ''}`}>
      <div className="container mx-auto p-4 bg-white dark:bg-gray-800 text-black dark:text-white">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold">Herramienta de Auditoría Web</h1>
          <Button
            variant="outline"
            size="icon"
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="text-2xl font-bold">Analiza tu sitio web</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="flex gap-2">
              <Input
                ...
                placeholder="Ingresa la URL para auditar"
                required
                className="flex-grow"
                disabled={loading}
              />
